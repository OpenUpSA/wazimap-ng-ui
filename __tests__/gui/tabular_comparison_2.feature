Feature: Tabular Comparison
  ...
  Scenario: Verify that the tabular comparison indicator filters works correctly
    ...
    Then I assert filter chip values on index 1 of result table header is "15-35 (ZA)"
    ...
    Then I assert filter chip values on index 1 of result table header is "30-35"
    ...
    Then I assert title on index 1 of result table header is "Language most spoken at home"
    Then I assert category chip value on index 1 of result table header is "English"
    Then I assert filter chip values on index 1 of result table header is "30-35,Female"
    ...
    Then I check if filters for indicator panel 2 is not visible
    Then I click on category autocomplete
    Then I search for Unemployed in category autocomplete
    Then I select Unemployed in autocomplete dropdown
    Then I check if filters for indicator panel 2 is visible
    Then I check if filter row count for indicator panel 2 is 1
    ...
    Then I assert filter chip values on index 2 of result table header is "20-24"
    ...
    Then I check if filters for indicator panel 3 is not visible
    Then I click on category autocomplete
    Then I search for No in category autocomplete
    Then I select No employed adult in autocomplete dropdown
    Then I check if filters for indicator panel 3 is visible
    Then I check if filter row count for indicator panel 3 is 1
    ...
    Then I assert filter chip values on index 3 of result table header is "15-35 (ZA)"
    ...
    Then I assert filter chip values on index 1 of result table header is "age group: 30-35,gender: Female"
    Then I assert value for index 1 column is "13,971"
    ...
    Then I assert filter chip values on index 2 of result table header is "age group: 20-24"
    Then I assert value for index 2 column is "22.55%"
    ...
    Then I assert filter chip values on index 3 of result table header is "age group: 15-35 (ZA)"
    Then I assert value for index 3 column is "54%"
