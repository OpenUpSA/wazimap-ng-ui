...
export function configureProfileEvents(controller, objs = {profileLoader: null}) {
    ...
    controller.on(VersionController.EVENTS.ready, () => profileLoader.updateActiveVersion(controller.versionController.activeVersion));
    controller.on(VersionController.EVENTS.updated, () => profileLoader.updateActiveVersion(controller.versionController.activeVersion));
