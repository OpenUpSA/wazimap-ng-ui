from behave import *
from pages.locators import Tutorial
import time


@when("I click on tutorial")
def step_impl(context):
    tutorial_xpath = context.common.find_element_by_xpath(Tutorial.tutorial)
    context.common.click_item(tutorial_xpath)


@step("I click on next")
def step_impl(context):
    next_button_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_next_button)
    context.common.click_item(next_button_xpath)


@step("I click on back arrow")
def step_impl(context):
    back_button_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_back_button)
...
def step_impl(context):
    ...
    tutorial_close_button_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_close_button)
    context.common.click_item(tutorial_close_button_xpath)


@then("Tutorial dialog box and Introduction should be displayed")
def step_impl(context):
    tutorial_header_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_header)
...
def step_impl(context):
    tutorial_location_search_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_location_search)
...
def step_impl(context):
    tutorial_location_panel_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_location_panel)
...
def step_impl(context):
    tutorial_rich_data_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_rich_data)
...
def step_impl(context):
    tutorial_point_mapper_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_point_mapper)
...
def step_impl(context):
    tutorial_data_filtering_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_data_filtering)
...
def step_impl(context):
    tutorial_learn_more_xpath = context.common.find_element_by_xpath(Tutorial.tutorial_learn_more)
